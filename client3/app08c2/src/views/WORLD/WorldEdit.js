...
// import   jsonServerProvider  from 'ra-data-json-server';
   ...
   import   AuthService         from "../FRAUTH/AuthService";                           // .(10417.03.7).(10420.04.12) 
...
//         options.headers.get( 'x-access-token')
   ...
   return  fetchUtils.fetchJson( url, options );
           }                                                                            // .(10420.03.3 Beg RAM Added)
//         ------------------------------------------------------------------

//  const  dataProvider = simpleRestProvider( 'http://localhost:3000', httpClient);     // .(10420.03.4 RAM From example in docs)             
    const  DataService  = restServerProvider(  API_URL,                httpClient );    // .(10420.03.4 RAM Add httpClient)            
