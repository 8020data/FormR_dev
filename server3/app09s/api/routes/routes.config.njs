       ...
       var  pTableRoutes =
              { 'default'    :
                  ...
                  , 'http.get     /api/${aTable}/'     : 'default_controller.getAll   '        // Retrieve all table records
                  , 'http.get     /api/${aTable}/:id'  : 'default_controller.getOne   '        // Update a table record with id
                  , 'http.get     /api/${aTable}/:ids' : 'default_controller.getMany  '        // Update a table record with id
