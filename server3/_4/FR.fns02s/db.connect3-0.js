...
//   var pFS = require( 'fs' ), aFile2 = 'my.config.json', aDir = `${APP_HOME}/api/config/`                 //#.(10317.02.1 Was __dirname).(10329.05.15)
     var pFS = require( 'fs' ), aFile2 = 'my.config.json', aDir = `${APP_HOME_API}/config/`                 // .(10317.02.1 Was __dirname).(10329.05.15)
