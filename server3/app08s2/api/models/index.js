...
//    FormR.setEnv( ); FormR.Help()                                                         // .(10317.03.8 RAM Only necessary if you need process.env vars to be read from .env)
...
//var pDB                =  require( `${FORMRs_4}SDB_Connect3-1.js` )( 'FORMR' )            //#.sequelize// .(10325.04.2 RAM Gotta use FORMRs_4).(10326.02.x).(10328.05.1) 
  var dbConnect          =  require( `${FORMRs_4}db.connect3-1.js` )                        // .sequelize// .(10325.04.2 RAM Gotta use FORMRs_4).(10326.02.x).(10328.05.1 RAM We love to change names) 
      ...
      pDB                =  { }
//var pDB                =  dbConnect( '' )                                                 //#.(10220.10.3).(10328.06.4 RAM Back to a normal app).(10414.02.1 RAM User FORMR DB)
//var pDBs               =  {};                                                             // .(10416.01.1)
//var pDB1               =  dbConnect( 'FORMR' );                                           // .(10220.10.1 RAM Switch to db.connect).(10328.0x.x).(10414.02.2)
//    pDBs[ pDB.DBSN  ]  =  pDB1                                                            // .(10416.01.2 RAM This is they way to have muptiple DBs, Not quite, DBSN is assigned to pDB.table.DBSN ) 
//var pDB2               =  dbConnect( 'MySQL_VULTR_IO' );                                  //#.(10319.10.1 RAM Switch to DBSN directly with db.connect)
//    pDBs[ pDB2.DBSN ]  =  pDB2                                                            // .(10416.01.3)
  var pDB2               =  dbConnect( 'MySQL_AWS_WORLD' );                                 // .(10220.10.1 RAM Switch to db.connect).(10328.0x.x).(10414.02.2)
//    pDBs[ pDB.DBSN  ]  =  pDB2                                                            // .(10416.01.4) 
                                
//    pDB.fruser         =  require( `${FORMRs_4}FRS_user.model.js`          )( '4FORMR', 'frusers'         )   //#.(10317.08.1)
//    pDB['fr/user']     =  require( `${FORMRs_4}fr.user.model1-0.js`        )(  pDB1,    'users'           )   // .(10317.08.1 RAM)
//    pDB2.fruser        =  require( `${FORMRs_4}FMR_UserModel1-0.js`        )(  pDB1,    'users'           )   // .(10317.08.1 RAM)
//    pDB.fruser         =  require( `${FORMRs_4}FMR_UserModel1-0.js`        )(  pDB1,    'frusers'         )   // .(10317.08.1 RAM)
//    pDB.fruser         =  require( `${FORMRs_4}FMR_UserModel1-0.js`        )(  pDB1,    'users'           )   // .(10323.01.1 RAM This is the real Table name in the database.  Why is a FormR Table being defined here?).(10326.07.1 RAM It's shouldn't be)
//    pDB.fruser         =  require( `${FORMRs_4}FormR/models/user.model.js` )(  pDB1,    'users'           )   // .(10326.07.2 RAM Yet another path).(10328.06.5) 
//    pDB.frrole         =  require( `${FORMRs_4}FormR/models/role.model.js` )(  pDB1,    'roles'           )   // .(10326.07.3).(10328.06.6) 

//    pDB.fruser         =  require( "${FORMRs_4_API}/models/fruser.model.js")(  pDB1,    'users'           )   //#.(10220.10.4 RAM Was: (sequelize, Sequelize) ).(10328.06.7).(10414.02.3
//    pDB.fruser         =  require(              "../models/fruser.model.js")(  pDB1,    'users'           )   // .(10220.10.4 RAM Was: (sequelize, Sequelize) ).(10328.06.8) 
//    pDB.fruser.DB      =  pDB1 // or pDBs[ pDB[ pDB.DBSN ] ]                                                  // .(10416.01.5) 

//    pDB.frrole         =  require( "${FORMRs_4_API}/models/frrole.model.js")(  pDB1,    'roles'           )   //#.(10309.03.1 RAM Need this).(10328.06.8).(10414.02.4) 
//    pDB.frrole         =  require(              "../models/frrole.model.js")(  pDB1,    'roles'           )   // .(10309.03.1 RAM Need this).(10328.06.8) 
//    pDB.frrole.DB      =  pDB1 // or pDBs[ pDB[ pDB.DBSN ] ]                                                  // .(10416.01.5) 

//    pDB.tutorial       =  require( "../models/tutorial.model.js"           )(  pDB,     'tutorials'       )   // .(10325.03.1)

      pDB.city           =  require( "../models/city.model.js"               )(  pDB2,    'city'            )   //#.(10326.03.4 RAM Add World models).(10326.07.x RAM Not in this FormR database)
      pDB.city.DB        =  pDB2 // or pDBs[ pDB[ pDB.DBSN ] ]                                                  // .(10416.01.6) 

      pDB.country        =  require( "../models/country.model.js"            )(  pDB2,    'country'         )   //#.(10326.03.5).(10326.07.x) 
      pDB.country.DB     =  pDB2 // or pDBs[ pDB[ pDB.DBSN ] ]                                                  // .(10416.01.7) 

//    pDB.countrylanguage=  require( "../models/countrylanguage.model.js"    )(  pDB2,    'countryLanguage' )   //#.(10326.03.6).(10326.07.x)
//    pDB.countrylanguage.DB =  pDB2 // or pDBs[ pDB[ pDB.DBSN ] ]                                              // .(10416.01.8) 
...
//        nDoTests       =  2          // 2. Check if pDB[ 'fruser'  ].create works
//        nDoTests       =  3          // 3. Check if pDB[ 'city'    ].authenticate works
          nDoTests       =  4          // 4. Check if pDB[ 'city'    ].findAll works
//        nDoTests       =  5          // 5. Check if pDB[ 'country' ].authenticate works
...
// -------------------------------------------------------------------------------------------------
      ...
      if (doTest( 2, __filename )) {   // 2. Check if pDB[ 'fruser' ].create works
...
//    ----------------------------------------------------------------------------------
      ...
      if (doTest( 3, __filename )) {   // 3. Check if pDB[ 'city'   ].authenticate works
...
//    var pData = await pDB[ aModel ].findByPk( aId ) 
   ...
   .then( pBody => {
      if (pBody) {
//        console.log(  pBody.toJSON( ) ); // Not needed 
          console.log(  JSON.stringify( pBody, null, 4 ) ); // This is also good!
      } else { 
...
//    ----------------------------------------------------------------------------------
      ...
      if (doTest( 5, __filename )) {   // 5. Check if pDB[ 'country' ].authenticate works
...
//    ----------------------------------------------------------------------------------
      ...
      if (doTest( 6, __filename )) {   // 6. Check if pDB[ `${aModel}` ].findByPk works for country
 
      var aModel = 'country';   aId =  1
