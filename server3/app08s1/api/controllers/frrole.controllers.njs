...
//      var aModel          =  require( 'fs' ).readFileSync( `${APP_HOME}/api/models/role.model.json`,      'ASCII' ) // .(10316.02.1 RAM ).(10328.06.11).(10329.01.1 RAM Don't use variable).(10414.04.2)
        var aModel_JSON     =  require( 'fs' ).readFileSync( `${APP_HOME}/api/models/${aModel}.model.json`, 'ASCII' ) // .(10414.04.2 RAM Use frrole to be conistent. Or it could be ${aModel} as it was)
