...
//  logging: function (str) { console.log(str); }, // do your own logging
    logging: function (str) { a = str;          }, // do your own logging
...
db.roles_tables = require("../models/roles_tables.model.js")(
  sequelize,
  Sequelize
); // .(01115.01.2)
db.user_roles = require("../models/user_roles.model.js")(sequelize, Sequelize); // .(01115.01.2)
db.members_projects = require("../models/members_project.model.js")(
  sequelize,
  Sequelize
); // .(01028.03.1 RAM Added)
